...
import { stockTransactionsResponseSchema, type StockTransactionsResponse } from "@/lib/schemas";
...
export async function fetchStockTransactionsAction(): Promise<{
  ...
  try {
    ...
    const validatedData = stockTransactionsResponseSchema.parse(rawData);
